...
capture_prob
```
The coverage probability for 1000 times simulations is 0.977. By definition, a 95% will be effective, our result is higher than the standard. 

I might change the simulation to learn more about the operating characteristics by selecting alternative distribution. For example, I will use Gamma or Weibull distribution what we have used in previous deliverables to construct 95% confidence interval. 
