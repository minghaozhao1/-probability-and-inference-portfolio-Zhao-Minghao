...
log(exp(x))
```
They are always equal. Exponential to the power of log is always equal to 1. When changing the value in it, it will always keep the value of X. It just changed the order of the function, whether the exponential first or the natural log first. 
